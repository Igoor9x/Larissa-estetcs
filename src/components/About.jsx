...
export default function About() {
  return (
    <>
    <section id="about">
      <div className=" flex px-10 gap-16 justify-center items-center">
        ...
        <div className="flex flex-col items-start justify-center text-start w-1/2">
          <div className="text-center lg:text-start py-2 w-[600px]">
            <h2 className="text-[60px] font-semibold font-[cormorantGaramond] text-[#2C1A0F] leading-[1]">Dra. Larissa Almeida</h2>
            <span className="text-lg text-yellow-700">Cirurgiã Especialista em Harmonização Facial</span>
