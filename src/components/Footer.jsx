...
export default function Footer() {
  ...
  return (
    ...
    <section id="contato" className="bg-[#FEFCF9]">
      <h2 className="text-[36px] font-bold mb-4 text-center pt-10">Venha nos conhecer</h2>
      <div className=" px-10 py-10 flex items-start justify-between max-tab:px-5">
        <div className="max-w-[1440px] flex items-start gap-10 mx-auto max-lap:flex-wrap max-lap:justify-around max-tab:flex-wrap-reverse max-tab:justify-center">
          ...
          <div className="w-[350px] max-tab:w-full">
            ...
            <img 
              ...
              className="rounded-lg mt-2 mb-2 w-[350px] h-[320px] object-cover max-tab:w-full"
            />
      ...
      <div className="gap-4 border-t py-4 px-5 text-[14px] text-yellow-900">
        <div className="flex justify-around items-center max-w-[1440px]">
          <img src="/assets/logo2.png" alt="Logo" className="w-auto h-20" />
          <span>© 2026 Larissa Almeida Harmonização Facial. Todos os direitos reservados.</span>
        </div>
      </div>
