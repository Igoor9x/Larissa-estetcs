...
export default function Hero() {
  return (
    <>
      <section id="heroBanner" className= "bg-[url('/assets/heroBanner2.png')] h-180 bg-cover flex items-center justify-start px-[120px] max-lap:px-[40px] max-tab:px-5 max-mob:px-[20px] max-tab:bg-[url('/assets/heroBanner2-tablet.png')]  max-mob:bg-[url('/assets/heroBanner2-mobile.png')] max-mob:h-160">
        <div className="flex flex-col justify-center w-[550px] rounded-lg p-5 pt-[100px] max-tab:p-0 max-tab:pt-[50px] max-mob:pt-[0px]">
          ...
          <div className="flex gap-4">
            ...
            <button className="text-[18px] px-4 py-2 rounded mt-6 block cursor-pointer text-yellow-700 bg-white border border-yellow-700  transition-all duration-300 hover:bg-yellow-900 hover:text-white hover:border-yellow-900 max-tab:text-[16px] max-mob:text-[12px]">Conhecer Tratamentos</button> 
          </div>
